    ...
    "encryption": "WPA"
        ...
        <div className="mt-12 pt-8 border-t border-[var(--border)] flex items-center justify-between text-sm text-[var(--muted-foreground)]">
          ...
          <div className="flex gap-4">
            <Link to="/policies/privacy" className="underline underline-offset-4 hover:text-[var(--foreground)]">
              Privacy Policy
            </Link>
            <Link to="/policies/tos" className="underline underline-offset-4 hover:text-[var(--foreground)]">
              Terms of Service
            </Link>
          </div>
        </div>
